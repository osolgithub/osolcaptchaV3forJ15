...
class JElementpreviewcaptchawithsettings extends JElement 
{
	/**
	 * Element name
	 *
	...
	var $_name = 'previewcaptchawithsettings';
		...
		$elementData = "
					...
					<script>
						function previewOSOLCaptcha(e,text){
							...
							ajaxLoaderURL = '".JURI::base()."../plugins/system/osolCaptcha/ajax-loader-big.gif';
							...
							ToolTip.style.top = (e.clientY-($('paramsletterSize').value * 3)) + 'px';
