...
require_once($adminIndexpath);
    ...
    $isAdmin = ($user->usertype == "Super Administrator" || $user->usertype == "Administrator");
    ob_end_clean(); 
    if ($isAdmin) {
