...
require_once(dirname(__FILE__).DS.'osolCaptcha'.DS.'OSOLmulticaptcha.php');
		  ...
		  $captchaVerifyURL = JURI::base()."index.php";
		   $ajax = "
						...
						window.addEvent( 'domready', function() {
								...
								onsubmitFunction =  $scriptToGetForm.onsubmit;//get('onsubmit');
	 ...
	 function adminOptionsForm()
	   {
		   ...
		   JHTML::stylesheet(JURI::base() . 'plugins/system/osolCaptcha/captchaStyle.css');//, $path);
